...
const file_proto_healthcheck_proto_rawDesc = "" +
	"\n" +
	"\x17proto/healthcheck.proto\x12\x0egrpc.health.v1\".\n" +
...
var (
	...
	file_proto_healthcheck_proto_rawDescData []byte
)

func file_proto_healthcheck_proto_rawDescGZIP() []byte {
	file_proto_healthcheck_proto_rawDescOnce.Do(func() {
		file_proto_healthcheck_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_healthcheck_proto_rawDesc), len(file_proto_healthcheck_proto_rawDesc)))
	})
...
func file_proto_healthcheck_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_healthcheck_proto_rawDesc), len(file_proto_healthcheck_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
