...
const file_proto_product_info_proto_rawDesc = "" +
	"\n" +
	"\x18proto/product_info.proto\x12\tecommerce\x1a\x1egoogle/protobuf/wrappers.proto\"e\n" +
	"\aProduct\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x02R\x05price2\x8d\x01\n" +
	"\vProductInfo\x12>\n" +
	"\n" +
	"addProduct\x12\x12.ecommerce.Product\x1a\x1c.google.protobuf.StringValue\x12>\n" +
	"\n" +
	"getProduct\x12\x1c.google.protobuf.StringValue\x1a\x12.ecommerce.Productb\x06proto3"
